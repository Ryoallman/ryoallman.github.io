            ...
            <div class="card-body">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="isi" class="form-control" cols="30" rows="10"><?php echo set_value('isi'); ?></textarea>
                        <small class="text-danger"><?php echo form_error('isi'); ?></small>
                    </div>
                    <div class="row">
                        <div class="col-md-4 form-group">
                            <label>Dana yang dibutuhkan</label>
                            <input type="number" class="form-control" min="1" name="jml" value="<?php echo set_value('jml'); ?>">
