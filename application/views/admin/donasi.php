								...
								<tbody>
									...
									<?php foreach($donasi as $don): ?>
										<tr>
											...
											<td>
												<a href="admin/donasi/terima/<?php echo $don['donasi_id']; ?>" class="btn btn-sm btn-white text-warning me-2"><i class="fa fa-check me-1"></i> Terima</a>
												<a href="admin/donasi/tolak/<?php echo $don['donasi_id']; ?>" class="btn btn-sm btn-white text-danger me-2"><i class="fa fa-times me-1"></i> Tolak</a>
											</td>
										</tr>	
									<?php $i++; ?>
									<?php endforeach; ?>
